...
public final class ModProfileManager {
    ...
    public static void exportTo(File dest) throws Exception {
        ...
        mods.addProperty("showKeystrokesMouse", ModernConfig.showKeystrokesMouse);
        mods.addProperty("showNametagHealth", ModernConfig.showNametagHealth);
        mods.addProperty("showWatermark", ModernConfig.showWatermark);
        mods.addProperty("showInventoryTags", ModernConfig.showInventoryTags);
        mods.addProperty("showWaypoints", ModernConfig.showWaypoints);
        mods.addProperty("itemTracker2d", ModernConfig.itemTracker2d);
        mods.addProperty("itemTracker3d", ModernConfig.itemTracker3d);
        mods.addProperty("armorDurabilityAlert", ModernConfig.armorDurabilityAlert);
    ...
    public static void importFrom(File src) throws Exception {
        ...
        if (root.has("mods")) {
            ...
            ModernConfig.showKeystrokesMouse = bool(m, "showKeystrokesMouse", ModernConfig.showKeystrokesMouse);
            ModernConfig.showNametagHealth = bool(m, "showNametagHealth", ModernConfig.showNametagHealth);
            ModernConfig.showWatermark = bool(m, "showWatermark", ModernConfig.showWatermark);
            ModernConfig.showInventoryTags = bool(m, "showInventoryTags", ModernConfig.showInventoryTags);
            ModernConfig.showWaypoints = bool(m, "showWaypoints", ModernConfig.showWaypoints);
            ModernConfig.itemTracker2d = bool(m, "itemTracker2d", ModernConfig.itemTracker2d);
            ModernConfig.itemTracker3d = bool(m, "itemTracker3d", ModernConfig.itemTracker3d);
            ModernConfig.armorDurabilityAlert = bool(m, "armorDurabilityAlert", ModernConfig.armorDurabilityAlert);
