...
public class GuiKeybinds extends GuiScreen {
    ...
    private static final String[] LABELS = {
        "Mod Menu", "Editar HUD", "Correr toggle (M)", "Correr toggle legacy (N)",
        "Fullbright", "Freelook", "Hypixel Quick Play"
    };
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int px = width / 2 - 150;
        int py = height / 2 - 80;
        Gui.drawRect(px, py, px + 300, py + 210, 0xCC0A0C14);
    ...
    private static int getKey(int index) {
        switch (index) {
            ...
            case 3: return ModConfig.keyToggleSprintLegacy;
            case 4: return ModConfig.keyFullbright;
            case 5: return ModConfig.keyFreelook;
            case 6: return ModConfig.keyQuickPlay;
            default: return 0;
        }
    }
    ...
    private static void setKey(int index, int code) {
        switch (index) {
            ...
            case 3: ModConfig.keyToggleSprintLegacy = code; break;
            case 4: ModConfig.keyFullbright = code; break;
            case 5: ModConfig.keyFreelook = code; break;
            case 6: ModConfig.keyQuickPlay = code; break;
            default: break;
        }
    }
