...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::bedrock::list_bedrock_versions,
            commands::bedrock::list_installed_bedrock_versions,
            commands::bedrock::install_bedrock_version,
            commands::bedrock::switch_bedrock_version,
            commands::bedrock::remove_bedrock_version,
            commands::bedrock::launch_bedrock_version,
            commands::bedrock::bedrock_developer_mode,
            commands::bedrock::enable_bedrock_developer_mode,
            commands::bedrock::backup_bedrock_saves,
            commands::bedrock::open_microsoft_store_bedrock,
            commands::bedrock::list_bedrock_worlds,
            commands::bedrock::list_bedrock_packs,
            commands::bedrock::open_bedrock_folder,
