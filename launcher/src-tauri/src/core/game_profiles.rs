...
pub fn resolve_server(
    ...
    match destination_id {
        ...
        "minemen" => Ok(Some("na.minemen.club".into())),
...
fn pvp_destinations() -> Vec<GameProfileDestination> {
    vec![
        GameProfileDestination {
            id: "hypixel".into(),
            label: "Hypixel".into(),
            description: Some("mc.hypixel.net · BedWars / SkyWars 1.8 · Premium".into()),
            server_address: Some("mc.hypixel.net".into()),
            needs_favorite: false,
        },
        GameProfileDestination {
            id: "minemen".into(),
            label: "Minemen Club".into(),
            description: Some("na.minemen.club · Practice · Premium".into()),
            server_address: Some("na.minemen.club".into()),
            needs_favorite: false,
        },
        GameProfileDestination {
            id: "cubecraft".into(),
            label: "CubeCraft".into(),
            description: Some("play.cubecraft.net · Premium".into()),
        ...
        GameProfileDestination {
            ...
            description: Some("mc.universocraft.net · LATAM".into()),
        ...
        GameProfileDestination {
            id: "mush".into(),
            label: "Mush".into(),
            description: Some("mush.com.br · BR / LATAM".into()),
        ...
        GameProfileDestination {
            ...
            description: Some("regorland.net · a menudo no-premium OK".into()),
        ...
        GameProfileDestination {
            ...
            description: Some("Sin auto-conectar".into()),
            server_address: None,
            needs_favorite: false,
        },
        GameProfileDestination {
...
fn modern_destinations() -> Vec<GameProfileDestination> {
    vec![
        GameProfileDestination {
            id: "hypixel".into(),
            label: "Hypixel".into(),
            description: Some("mc.hypixel.net · Premium".into()),
            server_address: Some("mc.hypixel.net".into()),
            needs_favorite: false,
        },
        GameProfileDestination {
