...
const FALLBACK_CLIENT_VERSION: &str = "2.1.60";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.60";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.60.jar",
        "7003707358fd026ab5a6fdb45e322410685e322e",
    ),
    (
