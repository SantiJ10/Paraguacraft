...
const FALLBACK_CLIENT_VERSION: &str = "2.1.63";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.63";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.63.jar",
        "2a7ee24d3b0dc0ccba7a6139f4f05820e0158609",
    ),
    (
