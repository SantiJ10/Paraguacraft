...
const FALLBACK_CLIENT_VERSION: &str = "2.1.39";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.39";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.39.jar",
        "a1b1ab263c9fd97a2031ce26707f9d7efa4242c4",
    ),
    (
