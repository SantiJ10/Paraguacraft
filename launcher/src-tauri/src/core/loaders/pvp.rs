...
const FALLBACK_CLIENT_VERSION: &str = "2.1.17";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.17";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.17.jar",
        "919f6e354060b4ab5c36c88de801ae05b952fd3c",
    ),
    (
