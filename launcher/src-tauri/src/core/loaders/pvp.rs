...
const FALLBACK_CLIENT_VERSION: &str = "2.1.58";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.58";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.58.jar",
        "07510504ec311d73ee2f733530d5a6c60580c9b8",
    ),
    (
