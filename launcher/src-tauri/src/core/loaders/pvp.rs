...
const FALLBACK_CLIENT_VERSION: &str = "2.1.53";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.53";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.53.jar",
        "5278a88f751a8c93771be3d6d121d6564427d80e",
    ),
    (
