...
const FALLBACK_CLIENT_VERSION: &str = "2.1.50";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.50";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.50.jar",
        "7519f4e666d11e37f30b55b2ec789b1957b9e876",
    ),
    (
