...
const FALLBACK_CLIENT_VERSION: &str = "2.1.23";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.23";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.23.jar",
        "bdadc79990d0f03676bac976895effb76ccf7350",
    ),
    (
