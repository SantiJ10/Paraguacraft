...
const FALLBACK_CLIENT_VERSION: &str = "2.1.5";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.5";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.5.jar",
        "e916d3871e98380df80a8c18b360c99177fce765",
    ),
    (
