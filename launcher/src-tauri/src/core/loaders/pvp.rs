...
const FALLBACK_CLIENT_VERSION: &str = "2.1.40";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.40";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.40.jar",
        "79d3cc33ac9e75eaf4a465de794f17b7024eda49",
    ),
    (
