...
const FALLBACK_CLIENT_VERSION: &str = "2.1.45";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.45";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.45.jar",
        "3327292caa1d95e972395ffb53a08fdce15d2a8f",
    ),
    (
