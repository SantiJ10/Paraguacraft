...
const FALLBACK_CLIENT_VERSION: &str = "2.1.8";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.8";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.8.jar",
        "aa4cf3a6c67909709078b5c0b6e771588fe0e117",
    ),
    (
