...
const FALLBACK_CLIENT_VERSION: &str = "2.1.0";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.0";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.0.jar",
        "d07f1e6a5f4af5c34a43d140784894087b6dde52",
    ),
    (
