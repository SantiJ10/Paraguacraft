...
const FALLBACK_CLIENT_VERSION: &str = "2.1.37";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.37";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.37.jar",
        "b8cbdcdb2a4672359540f4155cbe39269d7785ef",
    ),
    (
