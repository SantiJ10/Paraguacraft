...
const FALLBACK_CLIENT_VERSION: &str = "2.1.11";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.11";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.11.jar",
        "9e09d3aceea7e363991abdcdec26029046257f56",
    ),
    (
