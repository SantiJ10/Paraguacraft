...
const FALLBACK_CLIENT_VERSION: &str = "2.1.61";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.61";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.61.jar",
        "5eafedb3912cd0c1208bd96e4124c194eea69fed",
    ),
    (
