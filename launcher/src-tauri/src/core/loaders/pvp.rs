...
const FALLBACK_CLIENT_VERSION: &str = "2.1.62";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.62";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.62.jar",
        "6838f77fb78c5aa641db75cd5a0dcf584fa02175",
    ),
    (
