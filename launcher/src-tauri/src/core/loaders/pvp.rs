...
const FALLBACK_CLIENT_VERSION: &str = "2.1.29";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.29";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.29.jar",
        "3ea4bcc2c2d1032c1353e1aee6e0ffc6a15f5615",
    ),
    (
