...
const FALLBACK_CLIENT_VERSION: &str = "2.1.59";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.59";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.59.jar",
        "ffbb57e4544882c1ea33ee568819520c144617ce",
    ),
    (
