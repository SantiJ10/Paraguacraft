...
const FALLBACK_CLIENT_VERSION: &str = "2.1.51";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.51";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.51.jar",
        "068f477a05e170c532994c1137b45e4550401c0d",
    ),
    (
