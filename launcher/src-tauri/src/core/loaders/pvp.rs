...
const FALLBACK_CLIENT_VERSION: &str = "2.1.44";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.44";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.44.jar",
        "633fbcd8ab6479d15a108b1c61d67753bfd98c14",
    ),
    (
