...
const FALLBACK_CLIENT_VERSION: &str = "2.1.56";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.56";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.56.jar",
        "7df3b8ee7451f75c20b6b8d10b2eedc78b58b78c",
    ),
    (
