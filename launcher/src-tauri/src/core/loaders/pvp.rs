...
const FALLBACK_CLIENT_VERSION: &str = "2.1.28";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.28";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.28.jar",
        "21f6d768c5280433d0e0cec7fd8ccbc65e614e21",
    ),
    (
