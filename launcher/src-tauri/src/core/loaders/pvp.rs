...
const FALLBACK_CLIENT_VERSION: &str = "2.1.43";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.43";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.43.jar",
        "6ad2335e594f6f590a0e81bfaa356c4fdac563d7",
    ),
    (
