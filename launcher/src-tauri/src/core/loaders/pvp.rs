...
const FALLBACK_CLIENT_VERSION: &str = "2.1.18";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.18";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.18.jar",
        "e4c735e5b84faa08852ba10632b89f6336d706fd",
    ),
    (
