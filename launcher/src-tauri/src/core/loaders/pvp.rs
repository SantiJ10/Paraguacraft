...
const FALLBACK_CLIENT_VERSION: &str = "2.1.31";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.31";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.31.jar",
        "a5f487acdaec9bb7eda73d8cedf0f357ef321718",
    ),
    (
