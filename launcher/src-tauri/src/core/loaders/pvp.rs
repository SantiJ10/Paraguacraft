...
const FALLBACK_CLIENT_VERSION: &str = "2.1.57";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.57";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.57.jar",
        "412def7ce0b90ca1e12ca804155e639ae6897a70",
    ),
    (
