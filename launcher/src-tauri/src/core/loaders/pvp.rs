...
const FALLBACK_CLIENT_VERSION: &str = "2.1.42";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.42";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.42.jar",
        "38890a25f6a41f7783e8b2572da1fd0e93fb356d",
    ),
    (
