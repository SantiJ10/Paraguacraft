...
const FALLBACK_CLIENT_VERSION: &str = "2.1.30";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.30";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.30.jar",
        "2ba566a4f122fbc6809ecf6996891904838034e4",
    ),
    (
