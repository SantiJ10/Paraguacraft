...
const FALLBACK_CLIENT_VERSION: &str = "2.1.41";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.41";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.41.jar",
        "8ca133aa4cb3bbbd742ad53c4dca6d40cf244d63",
    ),
    (
