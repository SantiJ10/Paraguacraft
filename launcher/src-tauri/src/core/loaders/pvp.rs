...
const FALLBACK_CLIENT_VERSION: &str = "2.1.6";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.6";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.6.jar",
        "eff2f7a87b19b0373ad0aab1dfdb1544b5a71221",
    ),
    (
