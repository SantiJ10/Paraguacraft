...
const FALLBACK_CLIENT_VERSION: &str = "2.1.36";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.36";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.36.jar",
        "518ae42770fb6e129cbbcc06c8b2e9b79319f30e",
    ),
    (
