...
const FALLBACK_CLIENT_VERSION: &str = "2.1.7";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.7";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.7.jar",
        "9ad3ce2060a9b3ed57185e947eda33a5ef2a6364",
    ),
    (
