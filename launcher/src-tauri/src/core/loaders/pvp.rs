...
const FALLBACK_CLIENT_VERSION: &str = "2.1.52";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.52";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.52.jar",
        "d73a53206b78164993d1501523659e50e2c8ba87",
    ),
    (
