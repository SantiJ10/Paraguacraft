...
const FALLBACK_CLIENT_VERSION: &str = "2.1.38";
const FALLBACK_RELEASE_TAG: &str = "pvp-client-2.1.38";

const FALLBACK_MODS: &[(&str, &str)] = &[
    (
        "ParaguacraftPvP-2.1.38.jar",
        "68d6db39ed8d0741be3762bb29f891260bad21d4",
    ),
    (
