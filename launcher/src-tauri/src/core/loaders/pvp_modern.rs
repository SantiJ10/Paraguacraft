...
const FALLBACK_CLIENT_VERSION: &str = "0.9.1";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.1";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.1.jar",
    "05f53d6ca40a83eaf14480fdb0670a027d006501",
)];
