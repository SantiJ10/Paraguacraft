...
const FALLBACK_CLIENT_VERSION: &str = "0.9.16";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.16";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.16.jar",
    "85abfef5aa8b80cbfe8e0421940c606f69f6b0cc",
)];
