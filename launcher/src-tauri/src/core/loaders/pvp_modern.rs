...
const FALLBACK_CLIENT_VERSION: &str = "0.7.0";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.7.0";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.7.0.jar",
    "4a6595262d494eba70923e7326f17e6a96beea73",
)];
