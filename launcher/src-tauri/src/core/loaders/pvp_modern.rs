...
const FALLBACK_CLIENT_VERSION: &str = "0.9.0";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.0";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.0.jar",
    "676d3ac9547f0f8edb99ed35243a170dec9ae305",
)];
