...
const FALLBACK_CLIENT_VERSION: &str = "0.9.28";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.28";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.28.jar",
    "8d84c145dc9bbcb3e9feb68fed694d360b8df021",
)];
