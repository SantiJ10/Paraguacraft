...
const FALLBACK_CLIENT_VERSION: &str = "0.9.21";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.21";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.21.jar",
    "d1cea059fd345b79dd2d95860edee0473fa6a3dc",
)];
