...
const FALLBACK_CLIENT_VERSION: &str = "0.9.32";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.32";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.32.jar",
    "e32c83d95a2acd2f88204b99c2b41629876f5cba",
)];
