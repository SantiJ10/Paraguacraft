...
const FALLBACK_CLIENT_VERSION: &str = "0.8.0";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.8.0";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.8.0.jar",
    "03e01a74805e209697e269f2a2925bf0e06f4bc2",
)];
