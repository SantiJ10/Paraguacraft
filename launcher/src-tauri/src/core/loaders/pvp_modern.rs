...
const FALLBACK_CLIENT_VERSION: &str = "0.9.31";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.31";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.31.jar",
    "19f25458dd42f7284bafa8e40501743745f23ea5",
)];
