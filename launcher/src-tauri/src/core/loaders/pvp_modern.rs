...
const FALLBACK_CLIENT_VERSION: &str = "0.8.2";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.8.2";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.8.2.jar",
    "a79dcfd851459aeb15af779a4ee8f0954f76696",
)];
