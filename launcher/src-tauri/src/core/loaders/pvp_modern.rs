...
const FALLBACK_CLIENT_VERSION: &str = "0.9.27";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.27";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.27.jar",
    "9a508eedda4b84a9aa230bbf4ab9143d2e46acc4",
)];
