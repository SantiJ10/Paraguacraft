...
const FALLBACK_CLIENT_VERSION: &str = "0.9.36";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.36";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.36.jar",
    "558f4420ec461630c39fb4231fa52ea763f47c7e",
)];
