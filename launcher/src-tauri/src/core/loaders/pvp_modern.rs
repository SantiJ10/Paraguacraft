...
const FALLBACK_CLIENT_VERSION: &str = "0.9.30";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.30";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.30.jar",
    "9d646a960d5c88ba1545ee32e23d628a04ed7370",
)];
