...
const FALLBACK_CLIENT_VERSION: &str = "0.6.7";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.6.7";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.6.7.jar",
    "258094d6229db85dd01730e8885465134ec32ca4",
)];
