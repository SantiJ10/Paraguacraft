...
const FALLBACK_CLIENT_VERSION: &str = "0.6.2";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.6.2";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.6.2.jar",
    "432a2d93d4322a2902b5595e2978da29aeed1749",
)];
