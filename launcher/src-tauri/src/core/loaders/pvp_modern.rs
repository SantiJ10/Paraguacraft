...
const FALLBACK_CLIENT_VERSION: &str = "0.9.22";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.22";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.22.jar",
    "760c66be0266385126e4dd63e9c344ae0ed99f70",
)];
