...
const FALLBACK_CLIENT_VERSION: &str = "0.9.3";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.3";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.3.jar",
    "c6e903533016f3e012e1780722d5faf0447d5199",
)];
