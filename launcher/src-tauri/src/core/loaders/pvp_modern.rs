...
const FALLBACK_CLIENT_VERSION: &str = "0.6.3";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.6.3";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.6.3.jar",
    "b113d319e9285175812e5104141fef1a1720eda4",
)];
