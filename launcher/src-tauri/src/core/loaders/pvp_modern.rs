...
const FALLBACK_CLIENT_VERSION: &str = "0.4.1";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.4.1";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.4.1.jar",
    "99f2ddd258efd9507c82d5c60071489648fb56ba",
)];
