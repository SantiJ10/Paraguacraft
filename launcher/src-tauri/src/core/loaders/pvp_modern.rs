...
const FALLBACK_CLIENT_VERSION: &str = "0.8.1";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.8.1";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.8.1.jar",
    "1d603bd3e88cb0878445f3b9578eb0a58e37201d",
)];
