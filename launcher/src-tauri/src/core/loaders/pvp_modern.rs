...
const FALLBACK_CLIENT_VERSION: &str = "0.4.0";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.4.0";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.4.0.jar",
    "b5cf99d7cb21f85e18d002b443618c7bbe89ccfe",
)];
