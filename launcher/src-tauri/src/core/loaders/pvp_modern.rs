...
const FALLBACK_CLIENT_VERSION: &str = "0.4.2";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.4.2";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.4.2.jar",
    "43c613f8efde28f4d513256eec54234e88d49ba0",
)];
