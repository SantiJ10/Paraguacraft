...
const FALLBACK_CLIENT_VERSION: &str = "0.6.4";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.6.4";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.6.4.jar",
    "92526d32e0f440e3a965bff8dff2c781aa10e2e0",
)];
