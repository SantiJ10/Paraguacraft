...
const FALLBACK_CLIENT_VERSION: &str = "0.6.8";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.6.8";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.6.8.jar",
    "3b643e2dd8ebb4cba73cea031c466ec0476225b7",
)];
