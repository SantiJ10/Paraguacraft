...
const FALLBACK_CLIENT_VERSION: &str = "0.9.2";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.2";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.2.jar",
    "b23c42119debebee582439f9fbcb39f08e6dd5b9",
)];
