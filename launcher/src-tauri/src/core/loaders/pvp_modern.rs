...
const FALLBACK_CLIENT_VERSION: &str = "0.8.3";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.8.3";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.8.3.jar",
    "bfae95ad1388cef11b4fdc924da012ae89e6cec0",
)];
