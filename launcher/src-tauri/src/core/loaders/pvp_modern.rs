...
const FALLBACK_CLIENT_VERSION: &str = "0.9.33";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.33";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.33.jar",
    "c75f410dab32be5705460fbb4fbb92d8d2ff64bd",
)];
