...
const FALLBACK_CLIENT_VERSION: &str = "0.9.17";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.17";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.17.jar",
    "1d4a63d3d74159586447a368f270aad4ecd569f9",
)];
