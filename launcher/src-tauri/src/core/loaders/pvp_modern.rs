...
const FALLBACK_CLIENT_VERSION: &str = "0.5.0";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.5.0";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.5.0.jar",
    "1e6e41f2ddff996c67f28a44dffff360be282aa2",
)];
