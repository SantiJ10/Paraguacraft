...
const FALLBACK_CLIENT_VERSION: &str = "0.9.13";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.13";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.13.jar",
    "4f39fcad346989872bd5b961a5246bbce5e19926",
)];
