...
const FALLBACK_CLIENT_VERSION: &str = "0.6.5";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.6.5";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.6.5.jar",
    "a609348261f2e8280c32aa1646166dd9bd0f056e",
)];
