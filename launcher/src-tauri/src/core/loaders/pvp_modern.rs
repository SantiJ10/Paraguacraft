...
const FALLBACK_CLIENT_VERSION: &str = "0.9.20";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.20";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.20.jar",
    "e0935745ee97935dee2eac6f3bd05f25023298e2",
)];
