...
const FALLBACK_CLIENT_VERSION: &str = "0.9.4";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.4";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.4.jar",
    "e23b80e2f507b1888a2a11ef1c2e01326b81fa47",
)];
