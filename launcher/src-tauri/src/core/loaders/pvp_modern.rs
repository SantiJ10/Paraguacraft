...
const FALLBACK_CLIENT_VERSION: &str = "0.9.18";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.18";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.18.jar",
    "4d9123ff4442a5865f19c6ffcc3a115dfef13bd1",
)];
