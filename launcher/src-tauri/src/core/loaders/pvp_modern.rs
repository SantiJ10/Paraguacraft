...
const FALLBACK_CLIENT_VERSION: &str = "0.9.29";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.29";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.29.jar",
    "8a69dc7a2738ec38da5624678c43161bba377eab",
)];
