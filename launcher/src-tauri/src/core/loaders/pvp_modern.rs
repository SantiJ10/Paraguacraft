...
const FALLBACK_CLIENT_VERSION: &str = "0.6.6";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.6.6";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.6.6.jar",
    "6cbf897163074068dd4cb87827d4fd2121e9cce9",
)];
