...
const FALLBACK_CLIENT_VERSION: &str = "0.9.19";
const FALLBACK_RELEASE_TAG: &str = "pvp-modern-0.9.19";

const FALLBACK_MODS: &[(&str, &str)] = &[(
    "ParaguacraftPvP-Modern-0.9.19.jar",
    "8be4538de3db024ec07ac392d70983a0b0fc3e0b",
)];
